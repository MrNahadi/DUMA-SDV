...
- [ ] **01 · Scaffold.** App runs and shows an empty stage with the app shell. One unit test and one e2e test pass. Every Feedback command works. (Built interactively in Phase 2.)
