...
- [ ] **12 · Offline and deployment** [11]. PWA / service worker, documented offline check. Public static hosting is deferred (owner decision, 2026-09-25): the brief's "public URL" DoD item stays open until a later phase publishes `dist/`.
