...
- `docs/adr/0013-drive-modes-and-drive-cycles.md`; docs/design-rules.md §2 needs new data series colours before chart use (add in the chart ticket, with contrast check).
...
- **Phase 10 OTA** may "unlock a drive mode". Keep modes as a list with an availability flag so OTA can gate one later; all three are available in this phase.
