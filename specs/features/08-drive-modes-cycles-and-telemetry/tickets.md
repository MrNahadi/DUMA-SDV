...
Test seam: `createSim()` public API
Acceptance:
- [x] Full pedal in Eco with high motor and inverter losses (hot motor, low pack voltage) keeps battery discharge power at or below the cap
- [x] Normal and Sport snapshots are unchanged, and the 0–100, range and regen reference tests pass with unchanged tolerances
