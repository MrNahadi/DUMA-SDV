...
- **R3. Trip telemetry:** distance, run time, net energy at the pack, energy recovered, consumption (Wh/km; "Not enough distance" under 0.1 km), maximum speed, maximum battery power; charts of speed, battery power, SOC and the three temperatures over the drive log. Empty state when the log is empty: "No drive recorded yet."
