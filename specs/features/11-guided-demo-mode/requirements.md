...
- **R1.** A **Start demo** button in the top bar plays every scenario in order: Startup, Driving, Regen, Charging (AC), Charging (DC), Fault, OTA. It never starts on its own (docs/design-rules.md §10).
