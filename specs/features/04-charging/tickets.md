...
Acceptance:
- [x] Time-ordered samples show real charging progress and a gap for unavailable telemetry; history stays bounded
- [x] AC and DC are identified in words, and the chart has an accessible text summary
